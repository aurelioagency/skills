...
**Control 1 de 4.** Antes de disenar hay que entender el tema y recontarlo en lenguaje
comun. Despues, cada placa tiene que expresar una idea completa y entendible por si
sola. Nada de frases de titular vacias, terminos inventados ni ganchos rebuscados.

Del otro lado hay una persona leyendo. Si lee la placa y no entiende que le dijiste, no
...
- **Si la fuente ya lo explica bien, se dice igual que la fuente.** No hay ningún premio por
  ...
  Buscar una manera nueva de decir algo que ya estaba bien dicho es lo que produce las
  placas rebuscadas.
...
Poner el tema como título no es la salida fácil ni la opción sin trabajo: es lo que hay que hacer salvo que haya un motivo concreto para otra cosa. Casi siempre el gancho que se está buscando es el nombre del tema.
...
modo exacto en que esto falla. Devolver análisis en vez de una línea mejor es el mismo defecto
que las placas vagas, un nivel más arriba.
