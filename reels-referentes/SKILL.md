...
5. **Verificar que el recurso sea genuino.** Antes de entregarlo, fijate si hay señales de que sea trucho: varios repos casi idénticos con el mismo nombre bajo cuentas de GitHub distintas, números que se inflan de copia en copia, "cientos de contributors" en un proyecto nuevo, descripciones armadas como publicidad. Si ves eso, avisale al usuario explícitamente antes de que lo use — no se lo entregues como si fuera un hallazgo confiable.
